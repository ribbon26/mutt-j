...
　マニュアルファイルはリファレンス部分が未訳です。これは、ビルド時に
init.h の中にあるコメントを抜き出してマニュアル末尾に付加しているた
めです。

2.5 po ファイル

　メッセージカタログ(.po)の訳については、本家のメーリングリストで作業を
行っています。日本語化パッチとしては提供していません。
...
インストールに関しては INSTALL.JA-PATCH をお読み下さい。
インストールや設定に関して役に立つ文書へのリンクが http://
