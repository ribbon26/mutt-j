...
function plugin_comment_action()
{
	...
	if (! isset($vars['msg']) || $vars['msg'] == '' || $vars['kesu'] == 'true' || $vars['kesu'] != 'false'
	    || ! preg_match('/[ぁ-ん]/', $vars['msg']))
...
<form action="$script" method="post">
 <div>
  ...
  <input type="radio"  name="kesu" value="true" checked>迷惑コメント</input>
  <input type="radio"  name="kesu" value="false">ふつう(ひらがなが必要です)</input>
